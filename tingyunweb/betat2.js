...
window.TINGYUN = function(t, e) {
    ...
    function I(t) {
        function e(t, e, r) { var a = r || "log",
                i = n[t] || (n[t] = {});
            i[a] = i[a] || "", i[a] += e } var n = {},
            r = D(); if (e("Status", r, "ok" !== r), e("Debug", P()), i(Ko, function(t, n) { e("Timeline", n + ": " + t.toString()) }), !t && Vo) console.log("[TingYun Agent Diagnosis]\n"), i(n, function(t, e) { var n = console[e];
            i(n, function(t, e) { console[e](t) }) });
        else { if (t !== da) return Mr(n);
    ...
    function j(t) { var e = es.data; if (0 !== (es.flags & Xo)) { var n = es.create(es.data);
            void 0 !== n && (e = n) } return function r() { 0 !== (es.flags & $o) && es.before(this, e); var n = r;
            n._ && (n._ = 1); try { var a = t.apply(this, arguments) } catch (i) { throw 0 !== (es.flags & Zo) && es.error(e, i), i } return 0 !== (es.flags & Qo) && es.after(this, e), a } }
    ...
    function J(t, e) { e = e || b; var n = new Image;
        $r(n, oa, function() {
    ...
    function Tt(t) { if (null != t) { var e = Et();
            null != e && t !== e && gt(), as(Fi, t) } }

    function Ct() { var t = { did: St() },
            e = Et(); return e && (t.uid = e), t }
    ...
    function wt(t) { var e = {},
            ...
            i = it(t),
            o = i.queryObj,
            s = i.queryString; return o && (e = Rt(o, Lo.bizIdsRules[ma], Lo.bizIdsRules[ya]), n = Rt(o, Lo.customParamsRules[ma], Lo.customParamsRules[ya]), r = Rt(o, Lo.requestParamKeys[_a], Lo.requestParamKeys[xa]), a[ba] = It(o, Lo.optCustomParamRules[ba], !0)), { bizIdParams: e, params: n, requestParams: r, optCustomParams: Nt(a), operaAllParam: s } }

    function Rt(t, e, n) { var r = {}; return t && e && e.length && e.length > 0 && i(e, function(e) { var n = t[e];
            null != n && nt(r, e, n) }), t && n && n.length && n.length > 0 && i(n, function(e) { var n = Dt(wa, e),
                a = n(t);
            null != a && nt(r, e, a) }), r }

    function Dt(t, e) { var n = t + "." + e; if (Ss[n]) return Ss[n]; var r = (e || "").split("."),
            a = "";
        e && 0 !== e.indexOf("[") && (a = "."); var o = t;
        i(r, function(t, e) { 0 === e && (o += a), o += t.indexOf("-") > -1 && 0 !== t.indexOf("[") && t.indexOf("]") !== t.length - 1 ? "['" + t + "']" : (e > 0 ? "." : "") + t }); var s; try { s = new Function(t, "try{return " + o + ";}catch(e){}return null;") } catch (u) { s = b } return Ss[n] = s, s }
    ...
    function Ht(t) { if (!t.agent) { var e = window._ty_rum; if (e && e.agent) t.agent = e.agent;
            else { var n = Ot(Da, Ra);
                n && (t.agent = jt(n), kt(Da, "", -1e3, "/")) } } return t.agent }
    ...
    function Ft(t) { var e = {}; if (t) { var n = [So, Eo, To, Co, Ao];
            i(t.split(""), function(t, r) { e[n[r]] = "1" === t }) } return e }

    function zt(e) { var n = {}; if (Fr(e)) { var r = {};
            e(r), n = r.server } else n = e;
        t[Oa] || (t[Oa] = { hook: {} }), m(Ho.server, qo, n || {}, t[Oa].config || {}), m(Ho.appConf, { bizIdsRules: Ut(Mo.bizId_rule), customParamsRules: Ut(Mo.opt_param_rule), requestParamKeys: Ut(Mo.request_param_keys), corsDomains: Mo.cors_domains || [], optCustomParamRules: Ut(Mo.opt_custom_param_rule), ignoreNoFilePropError: Bt("ignore_err"), debuggable: Bt("debug"), sessionTimeout: Mo.session_timeout || Gi, collectAllParam: Ft(Mo.collect_all_param) }), i(Cs, function(e) { Mo[e] && (Lo.baseInfo[e] = Mo[e], t[la][e] = Mo[e]) }), m(Bo, Ct()); var a = mt(); if (bt(a) && (a = yt()), _t(a), Ho.server.event_timeout || (Ho.server.event_timeout = qa), Mo.appKey && Q(), Mo.apm_arms) { Mo.apm_headers || (Mo.apm_headers = []); var o = G() ? Mo.apm_headers.indexOf(ro) < 0 : g(Mo.apm_headers, ro) < 0;
            o && Mo.apm_headers.push(ro) }
        ht(Mo); var s = Ht(Ho);
        Lo.pageServerData = qt(s), Z(Mo.req_capacity) }

    function Yt(e) { try { var n; if (!e || !e.data || 0 !== e.data.indexOf("_TINGYUN")) return; if (n = e.data.replace("_TINGYUN", ""), Y(n)) { var r = Y(n); if ("gather" === r.type && "APM" === r.fromJS && !t[no]) { jo.isGather = !0; var a = e.origin,
    ...
    function $t(t) { var e = Go.cpParent; if (e) { if (t && (Go.recordingCpActions = !1), !R()) return void(Go.tryEndCpActionsFailed = !0); var n = e.action,
                r = e.data,
                a = e.commonActionInfo,
                o = e.url; if (n && r && 0 !== r.length) { var s = [];
                i(Go.cpActions, function(t) { t.data && (t.data.crossPage = !0), s.push(t.data) }), r[r.length - 1].items = s, Xt(n, r), n.data && (n.data.range = xo); var u = Jt(m(a || {}, { cpOptCustomParam: Go.opt_custom_param, pageParam: Mt() }));
                Kt(n, { commonActionInfoMessage: u, url: o, crossPage: !0 }) } } }

    function Qt(t) { if (t) { var e = t.action,
                n = t.data;
    ...
    function ne(t, e, n, r, a, i) { i = i || {}, this.id = ++Go.uniqueId, this.parent = t || null, this.children = [], this.name = e || "", this.type = n || Ha, this.subType = this.type === Ha ? r || "click" : r, this.items = [], this.remain = Zt(), this.s = i.s || S(), this.e = null, this.data = a, this.state = Qa, this.crossPage = i.crossPage || !1; var o = this;
    ...
    function ue(t) { return function() { var e = arguments[0],
                n = arguments[1],
                r = arguments[2],
                a = !0;
            r && zr(r) && r[Ri] && (a = !1); var i = se(n),
                o = i.isValid,
                s = i.listenerType; if (a && Ps.indexOf(e) > -1 && o) { var u; if (n[ao] && n[ao][this]) u = n[ao][this];
                else { var c = ae(n, Ii, s);
    ...
    function ce(t) { return function(e, n) { var r; try { r = t && t.apply(this, arguments) } finally { try { if (n && Ps.indexOf(e) > -1) { var a = n[ao];
    ...
    function le() { Object.getOwnPropertyDescriptor && Object.defineProperty && Ps.forEach(function(e) { var n = "on" + e,
            ...
            Object.defineProperty(t.HTMLElement.prototype, n, { get: function() { return a.apply(this, arguments) }, set: function() { var t = arguments[0];
                    t && (arguments[0] = ae(t, Oi, Ns)), i && i.apply(this, arguments) }, configurable: !0, enumerable: !0 }) }) }
    ...
    function ve(t) { try { if (!t) return ""; for (var e = [], n = t.parentNode, r = function() { var r = t.tagName,
                        a = void 0;
                    ...
                    i = a ? 1 === [].filter.call(a, function(t) { return t.tagName === r }).length ? r : "".concat(r, ":nth-child(").concat(1 + [].indexOf.call(a, t), ")") : r; var o = t.id ? "#".concat(t.id) : "",
                        s = t.className;
                    Br(s) && (s = pe(s)); var u = s ? s.split(" ").filter(function(t) { return pe(t) }).map(function(t) { return ".".concat(t) }).join("") : "";
    ...
    function ye(t, e, n) { var r = t.target,
            a = r.nodeName,
            i = r.id,
            o = r.className,
            s = r.title,
            ...
            p = t[Ro]; if (p || (p = ta(), t[Ro] = p), d.eventId = p, l) { var h = t.timeStamp && S();
            Hs && Math.abs(h - Hs.timestamp) <= js && (d.refId = Hs.eventId) } else Hs = { timestamp: t.timeStamp && S(), eventId: d.eventId }; if (ji === a) { var m = t.target.getAttribute("src");
            m && !he(m) && (d.src = m) } if (qi === a) { var v = t.target.getAttribute("href");
            v && (d.href = v) } return d.eventHandlerType = e, ne.createEvent(null, f, Ha, t.type || Di, d, n) }

    function _e(t, e) { Go.context = ye(t, e) }

    function xe() { var t = Go.context;
        t && t.canEnd() && t.end(), Go.context = null }

    function be(t, e) { var n = e.originalCallback,
            r = e.eventHandlerType,
            a = t[0],
            i = !a || !a.target || a[wi] || !(Os.indexOf(a.type) > -1); if (!i) try { _e.call(this, a, r) } catch (o) {}
        var s; try { s = n.apply(this, t) } finally { if (!i) try { Go.context && !Go.context.canEnd() && (a[wi] = !0), xe.apply(this) } catch (o) {} } return s }
    ...
    function Te(n) { var r = t.performance && t.performance.timing ? t.performance.timing.navigationStart : e,
            a = n.timeStamp; return a = a ? Ee(a) ? a : Math.round(n.timeStamp + r) : S() }

    function Ce(t) { var e = qs.filter(function(t) { return !t[wi] }),
            n = e[e.length - 1]; if (n) { var r = Te(n); if (Math.abs(r - t) < ks) return ye(n, ki, { s: r }) } }
    ...
    function De(t) { if (Ms[t.key]) { var e = Ms[t.key]; if (delete Ms[t.key], e.speBinded) { var n = e.setSpe(t);
                n || (!e.isMeaningfulAction() && e.isNoRemain() ? Re(t) : A(function() { e.sent || Re(t) }, fo)) } } else Re(t) }

    function Pe(t) { Vo && console.warn(t || "Event key required!") }

    function Ne(t) { t = t || {}, this.key = t.key, this.type = t.type || $i; var e = t.timeout || Vi;
    ...
    function Ie(t) { var e = null;
        e = Go.context ? ne.getEventRootContext(Go.context) : Ce(t.s), null != e && (Ms[t.key] = e, e.speBinded = !0) }

    function Oe(t) { t = t || {}; var e = t.key; if (!e) return new Pe; if (Ls[e]) return new Pe("event " + e + " is executing");
        Ls[e] = !0; var n = ss.createContext();
        ss.enter(n); var r = new Ne(t); return r._end = function() { var t = this;
            t.sent || t.stored || 0 !== t.remain || !t.called ? t.stored && this.refreshEventAndStore(n) : t.finish().send(n) }, r.end = function(t, e) { var r = this; return r.called ? void(Vo && console.warn("Event " + this.key + "has ended or failed!")) : (r.called = !0, ss.exit(n), r.status = null != t ? t : 1, void(e || r._end())) }, r.finish = function(t) { var e = this; return e.e = S(), e.i && clearTimeout(e.i), delete Ls[e.key], e }, r.fail = function() { this.end(0) }, r.store = function() { this.end(null, !0), this.refreshEventAndStore(n), this.stored = !0 }, r.i = r.timeout ? A(p(r.fail, r), r.timeout) : null, r.type === Qi && Ie(r), ss.set("event", r), r }

    function ke(e) { if (t.TINGYUN && t.TINGYUN.inited) { var n = rs(Ji),
                r = Y(n); if (r && r.start && (e = e || {}, !e.key || r.key === e.key)) { var a = e.timeout; if (a || (a = Ki), r.duration = S() - r.start, r.duration > a) return void is(Ji); var i = t.performance && t.performance.timing; if (i && i.navigationStart && (i.loadEventEnd || i.loadEventStart) && i.navigationStart - r.start >= 0) { var o = { method: "GET", url: document.URL, status: 200, type: La, subType: Ua, startSpeOffset: i.navigationStart - r.start, start: i.navigationStart, __spe: 1, du: (i.loadEventEnd || i.loadEventStart) - i.navigationStart };
                    r.xhrs || (r.xhrs = []), r.xhrs.push(o) } var s = 1;
                e.status && (s = e.status === to ? 1 : 0), r.status = s, is(Ji), De(r) } } }

    function je(e) { if (!t.TINGYUN || !t.TINGYUN.inited) return new Pe("Agent is not inited!");
        e = m({}, { type: Xi }, e || {}); var n = Oe(e); return e.autoEnd && A(function() { e.status && e.status === eo ? n.fail() : n.end() }, e.endDelay || Zi), n }

    function qe(t, e) { if (Ms[t]) { var n = Ms[t];
            n.id !== e.id && (e.speBinded = !0, Ms[t] = e) } }

    function He(e, n) { t.TINGYUN && t.TINGYUN.inited && (zr(n) || (n = {}), e && e.beforeEach && e.afterEach && (Mo.router_enable = !1, e.afterEach(function(e) { var r = e.fullPath; if (r = r ? t.location.origin + r : e.path) { var a = { key: r, type: Qi, autoEnd: !0, endDelay: co, debugInfo: { api: vo } };
                m(a, n), je(a) } }))) }

    function Le(t, e) { if (t) { var n = t.split("_"),
                r = n[0],
    ...
    function Ye(e) { Gs.on(na, E(function() { n(); var t = S();
            Me(function() { zs.load = t }), e.loadEventEnd = t, clearInterval(Ys) })), i([na, ra, aa, ia], function(e) { $r(t, e, function(t) { Me(function() {
                    (zs.e[e] || (zs.e[e] = [])).push(S()) }), Gs.emit(e, t) }) }); var n = E(function() { var n = S(); if (Me(function() { zs.end = n }), e.domContentLoadedEventStart = n, G() && t.performance && t.performance.getEntriesByName) { if (!Po.querySelectorAll) return;
                zo.resources = zo.resources || [], i(Po.querySelectorAll("head>link,head>script"), function(t) { var e; "LINK" == t.tagName ? e = t.href : "SCRIPT" != t.tagName || t.defer || t.async || (e = t.src), e && zo.resources.push(e) }) } }); if (G() && $r(Po, ua, n), $r(Po, oa, function(t) { Po.readyState === sa && n() }), (!G() || t.performance && !t.performance.getEntriesByName) && (Ys = setInterval(Fe, so)), !G()) try { ze("if(window.TINGYUN) {window.TINGYUN.".concat(uo, "=+new Date();}")) } catch (r) {} }
    ...
    function Ke(t, e, n, r, a, i, o, s, u) { var c = this;
        c.id = t, c.time = S(), c.msg = e, c.lineno = r, c.colno = a, c.filename = n, c.count = 1, c.stack = i && i.stack || "", c.module = o, c.trigger = s || Vs, c.metaData = u, c.fix(); var f = Je(e, r, a, o),
            l = $s[f];
        c.ep = l ? 0 : 1, $s[f] = !0, c.fep = 0, this.recordFileName() }

    function Ve(t) { var n = function(t) { var e = []; return i(t, function(t) { e.push(t.toObject()) }), e }(Xs.c); if (!n || !n.length) return null; var r = { fu: Js ? Js : Js++, os: parseInt((S() - (zo.pfStart || e)) / 1e3) };
        Fo.ulabel && (r.ulabel = Fo.ulabel), ne.buildImmediateAction(za, null, null, { actionOptions: m(r, { items: n }) }), Xs.reset() }

    function Xe(t, e, n, r, a, o, s) { if (e || !Lo.ignoreNoFilePropError) { var u = !1; if (i(Lo.domains, function(t) { return u = t.test(e), u ? !1 : void 0 }), !u) { var c = a && a.moduleId,
                    f = We(e, t, n, r, c),
                    l = Xs.get(f);
                l ? l.increase() : (l = new Ke(f, t, e, n, r, a, c, o, s), Xs.add(f, l), ws.errs && ws.errs.push(l)) } } }

    function $e() { var e = t.onerror;
        t.onerror = function(t, n, r, a, i) { return Xe(t, n, r, a, i), Fr(e) ? e.apply(this, arguments) : void 0 }, t.onerror._ty = !0 }

    function Qe() { var e = t.onerror;
        e && e._ty || $e() }

    function Ze(t, e) { if (t) { var n = t.message || "",
                r = t.stack,
                a = "",
                o = 0,
                s = 0; if (r) { var u = r.split(/\n/);
                i(u, function(t, e) { if (t && (t = t.trim()), t && 0 === t.indexOf("at ")) { var n = t.indexOf("("),
                            r = t.indexOf(")"); if (n && r) { var i = n + 1;
                            i > r && (i = r); var u = t.substring(i, r); if (u) { var c = u.split(":");
                                c && c.length > 2 && (a = (c.slice(0, c.length - 2) || []).join(":"), o = +c[c.length - 2], s = +c[c.length - 1]) } } } return a && Yr(o) && o > 0 && Yr(s) && s > 0 ? !1 : void 0 }) }
            Xe(n, a, o, s, { stack: r }, Ks, e) } }

    function tn() { var e = Zr(); return e ? $e() : $r(t, ea, function(e) { var n, r, a, i, o;
            (e instanceof t.Event || t.ErrorEvent && e instanceof t.ErrorEvent) && (n = e.message || e.error && (e.error.message || e.error.constructor.name) || "", r = e.lineno || 0, a = e.colno || 0, i = e.filename || e.error && e.error.filename || e.target && e.target.baseURI || "", i == Po.URL && (i = "#"), o = e.error), Xe(n, i, r, a, o) }), Gs.on([na, ra, aa, ia], function(t) { Ve() }).on(na, function() { e && hs(Qe) }), setInterval(Ve, Ws, !0) }

    function en(t) { if (t) { var e = Fo.firstScreenResources = Fo.firstScreenResources || [];
            Ur(t) || (t = [t]), i(t, function(t) { if (Br(t)) e.push(t);
                else if (Uo(t)) { var n = t.src || t.href;
                    n && e.push(n) } }) } }

    function nn(t) { Ur(t) || (t = [t]), i(t, function(t) { if (t) { if (!(t instanceof RegExp)) throw new Do("parameter's type requires RegExp");
                (Lo.domains || (Lo.domains = [])).push(t) } }) }

    function rn() { if (Object.defineProperty) { var e = t[fa];
    ...
    function on(n, r) { var a = 0;
        n = n || {}; var o = n.timing; if (n.getEntriesByName && o) a = o.domLoading, i(zo.resources, function(t) { var e = n.getEntriesByName(t); if (1 === e.length) { var r = e[0].responseEnd + o.navigationStart;
                r > a && (a = r) } }), a -= o.navigationStart, r.__fp = iu;
        else if (t.TINGYUN && t.TINGYUN[uo]) { var s = o && o.navigationStart ? o.navigationStart : e;
            a = t.TINGYUN[uo] - s, 0 > a && (a = 0), r.__fp = ou } else P("fp=0"), r.__fp = su; return Me(function() { zs._fp = a }), Math.round(a) }

    function sn(n, r) { r = r || {}; var a = r.timing || {},
            o = n.fp || 0;
        n.__fs = pu; var s = Po.createElement("img"); if (!s.getBoundingClientRect) return n.__fs = hu, Me(function() { zs.fs = o }), o; var u = zo.imageResources,
            c = t.innerHeight,
            f = t.innerWidth;
        c || (c = Po.documentElement.clientHeight), f || (f = Po.documentElement.clientWidth); var l = [];
        u.length > 0 ? i(u, function(t) { un(t.element, c, f) && l.push(t) }) : r.getEntriesByName && i(Po.querySelectorAll("img"), function(t) { un(t, c, f) && l.push({ element: t }) }); var d = a.navigationStart || e,
            p = (a.loadEventEnd || ws.loadEventEnd) - (a.navigationStart || e); return i(l, function(t) { if (t.loadTime) { var e = t.loadTime - d;
                e > o && (o = e, n.__fs = du) } else if (t.element && t.element.src) { var a = r.getEntriesByName(t.element.src); if (a.length) { var i = a[0],
                        s = i.responseEnd;
                    i.fetchStart <= p && s > o && (o = s, n.__fs = lu) } } }), Math.round(o) }

    function un(t, e, n) { return t.src && cn(fn(t), e, n) && !ln(t) }

    function cn(e, n, r) { if (e) { var a = t.pageYOffset,
    ...
    function dn(t) { for (; t && 1 === t.nodeType;) { if ("none" === pn(t) || "hidden" === t.type) return !0;
            t = t.parentNode } return !1 }

    function pn(t) { return t.style && t.style.display }

    function hn(t, n) { var r = e,
            a = 0,
            i = n && n.timing; return i && (r = i.navigationStart || r, a = i[ii] || i.domInteractive || i.domLoading || a), a ? t.__dr = uu : ws.domContentLoadedEventStart ? (a = ws.domContentLoadedEventStart, t.__dr = cu) : (a = ws._end, t.__dr = fu), a - r }
    ...
    function vn(n, r) {
        function a(t) { return n[t] > 0 ? n[t] - s : 0 } var o = {},
            s = r ? r.globalStart : e,
            u = r ? r.window : t,
            c = (r ? r.agent : ws) || {}; if (n) { Me(function() { var t = zs.t = {};
                ...
                p = a(vi),
                h = a(gi),
                m = a(yi); if (o.cs = h, o.ce = m, o.ds = f, o.de = l, (p - d > 0 || p > 0) && (o.es = d, o.ee = p), 0 == o.le) { var v = an(c);
                o.ue = v - s }
            c && (c._le = o.ue || o.le); var g, y; if (n.msFirstPaint) g = n.msFirstPaint, r || Me(function() { zs.fp = "m_" + g });
            else if ((y = u.chrome) && u.chrome.loadTimes) { var _ = u.chrome.loadTimes();
                _ && _.firstPaintTime && (g = 1e3 * _.firstPaintTime), r || Me(function() { zs.fp = "c_" + _.firstPaintTime }) } else c && c.firstPaint && (g = c.firstPaint, r || Me(function() { zs.fp = g }));
            g && (o.fp = Math.round(g - s), c.fp = o.fp), n[_i] ? o.sl = a(_i) : o.sl = 0 } else o = { t: s, le: an(c) - s }; return o.je = c && c.errs && c.errs.length || 0, o }

    function gn(e, n) { var r = vn(e, n),
            a = n ? n.window : t; if (!a) return {};
        mn(r, a.performance), r.dr = hn(r, a.performance), r.fs = sn(r, a.performance); var i = {}; return r && (i = { f: r.f, fp: r.fp, fs: r.fs, dr: r.dr, le: r.le, je: r.je }), i }

    function yn(t, e) { if (_n()) { var n = { rm: {}, em: [], cpm: {} };
    ...
    function bn(t, n) { var r = { tr: !1, tt: h(Po.title), charset: Po.characterSet };
        Fo.resources && m(r, Fo.resources), Me(function() { r.debug = zs }), Ue(); var a = ws.errs;
        i(a, function(t, r) { var i = t.toObject();
            i.o = i.o - n && n.navigationStart || e, a[r] = i }), r.err = a; var o, s = "getEntriesByType"; return t[s] ? o = t[s]("resource") : P(v(eu, [s])), o && (r.tr = !0, r.res = [], i(o, function(t) {
            function e(e) { var n = t[e]; return n > 0 ? n : 0 } var n = t.initiatorType,
                a = t.name,
                o = { o: e("startTime"), rt: n, n: a, f: e(ei), ds: e(pi), de: e(hi), cs: e(gi), ce: e(yi), sl: e(_i), qs: e(ni), rs: e(ri), re: e(ai), ts: t.transferSize || 0, es: t.encodedBodySize || 0 }; if ("xmlhttprequest" === n) { var s = Sn(a);
    ...
    function Tn() { var n = {},
            r = 0,
            a = t.performance;
        a && a.getEntriesByType && i(a.getEntriesByType("mark") || [], function(t) { if (t && t.name && t.startTime && 0 === t.name.indexOf(ka)) { var e = t.name.substring(ka.length);
                e && (n[e] = Math.round(t.startTime), r += 1) } }); var o = a && a.timing ? a.timing.navigationStart : e,
            s = t[Oa] && t[Oa].data,
            u = m({}, s || {}, Yo || {}); return u && a && a.timing && i(u, function(t, e) { zr(t) && t.timestamp && (n[e] = t.timestamp - o, r += 1) }), r > 0 ? n : null }

    function Cn(t, e) { var n = m({}, t || {}, { type: Ua }); return e && (n.body = e), n }

    function An(t, e) { var n = Mr(t),
            r = n ? n.length : 0; if (r > ja && t.res && t.res.length > 0) { t.res = t.res.slice(0, e); var a = Mr(t),
                i = a ? a.length : 0; return i > ja ? An(t, e - 10 > 0 ? e - 10 : 0) : t } return t }

    function wn() {
        var e = E(function() {
            function e(t) { return t ? "1" : "0" } if (!Go.pfSent) { var n = t.performance,
                    r = !!n,
                    a = n && n.timing;
                r || P(v(eu, ["pf"])); var o = m(vn(a), Lo.pageServerData, Fo),
                    s = m({}, us);
                mn(s, n), s.dr = hn(s, n), s.fs = sn(s, n); var u = m(o, s) || {},
                    c = Tn();
                c && i(c, function(t, e) { Yr(t) && t >= 0 && (u[e] = t) }); var f, l = "",
                    d = a ? En(a) : 0;
                i(["fp", "fs", "dr", "le"], function(t) { l += e((d ? u[t] - d : u[t]) >= Mo[t + "_threshold"]) }), r && l.indexOf("1") > -1 && (f = bn(n, a), u.ressize = !(!n || !n.getEntriesByName)), c && (f || (f = {}), f.mark = c), u.trflag = l || "0000", zo.pfStart = S(), delete u.firstScreenResources, delete u.resources; var p = wt(Po.URL); if (f || (f = { tr: !1, tt: h(Po.title), charset: Po.characterSet }), f.bizId_param = p.bizIdParams, f.opt_param = p.params, f.request_param = p.requestParams, Lo.collectAllParam[So] && p.operaAllParam && (f.opera_all_param = {}, f.opera_all_param[So] = p.operaAllParam), Go.opt_custom_param = p.optCustomParams, f) try { f = An(f, 150) } catch (g) {}
                var y = Cn(u, f),
                    _ = ne.buildImmediateAction(Ua, "", y, { notSend: Go.recordingCpActions });
                Go.recordingCpActions && (_.crossPage = !0, Go.cpActions.push(_), A(function() { $t(!0) }, mu)); try { yn(u, f) } catch (g) {}
                Go.pfSent = !0 } });
        return G() && xn() && !Go.pfSent && e(), Gs.on(na, function() {
            ...
            if (G() && Go.recordingCpActions) { var r = Mo.cross_page_delay ? Mo.cross_page_delay : Ai,
                    a = r - t;
                0 > a && (a = 0), mu = a }
            A(e, t)
        }).on([ra, aa, ia], e)
    ...
    function Nn(t, e, n) { var r = ta().replace(/-/g, ""),
    ...
    function On(t) { return function e(n, r) { var a = this,
                i = e; if (i._ && (i._ = 1), !a[pa]) { var o = a[fa] = {};
                o.method = n, o.url = r, o.id = xu++, o.jserror = !1; var s = ss.get("event");
                s && (o.key = s.key, s.remain++), Mn(o, Go.context), o.parentContext = o.context.parent, o.contextData = { type: La, id: o.id, cid: o.context.id, method: o.method, url: o.url, state: o.state, ignore: !1, jserror: o.jserror }, o.context && o.context.setData(o.contextData), o.parentContext && In(o), o.toJSON = function() {} } try { return t.apply(a, arguments) } catch (u) {} return G() ? void 0 : d(t, [a, arguments]) } }

    function kn(t) { return function e(n, r) { var a = this,
                i = e; if (i._ && (i._ = 1), !a[pa]) { var o = a[fa],
                    s = $n(n, Lo.optCustomParamRules);
                jo.isGather && (o.wReqHeaderParam || (o.wReqHeaderParam = {}), o.wReqHeaderParam[n] = r), o && s && (o.reqHeaderParam || (o.reqHeaderParam = {}), o.reqHeaderParam[n] = r), o.headerRecord || (o.headerRecord = {}), o.headerRecord[n] = r } try { return t.apply(a, arguments) } catch (u) {} return G() ? void 0 : d(t, [a, arguments]) } }

    function jn(t) { return function e(n) { var r = this,
                a = e; if (a._ && (a._ = 1), !r[pa]) { var i = r[fa]; if (i && (i.start = S(), i.reqSize = T(n), i.requestData = n, i.contextData && (i.contextData.start = i.start)), G()) { if (i.context && null == i.context.parent) { var o = Ce(i.start);
                        o && (i.context.parent = o, i.parentContext = i.context.parent, In(i)) }!i.parentContext && Go.recordingCpActions && (i.context.crossPage = !0, Go.cpRemain.ajax++, Go.cpActions.push(i.context)) } var s = ss.get("event");
                s && s.type === Qi && i.key === s.key && i.parentContext && qe(i.key, i.parentContext), zn(r); var u = Pn(i.url); if (Mo.x_server_switch && r.setRequestHeader && Mo.key && i && u) { var c = nr(),
                        f = "c=B|" + Mo.key;
                    c && (f += ";x=" + c), r.setRequestHeader(Pa, f), i.xTingyunSent = !0, Mo.apm_headers && (i.apms = Nn(r, Mo.apm_headers, i.headerRecord)) } } try { return t.apply(r, arguments) } catch (l) {} return G() ? void 0 : d(t, [r, arguments]) } }

    function qn(t) { i(bu, function(e, n) { var r = "on" + n;
    ...
    function Fn(t, e) { if (G()) { var n = t[_u];
            n && !t[Bi] && (M(t, _u, e), t[Bi] = !0) } var r = t[Su];!r || t[Bi] || r[Bi] || (M(t, Su, e), t[Bi] = !0) }

    function zn(t) {
        function e(e) { return L(function n() { var r = n;
                r._ && (r._ = 1), Yn(t); var a; if (Fr(e)) { var i = t[fa]; if (i && 4 == t.readyState) { var o = S();
                        Bn(i, t) } try { a = e.apply(this, arguments) } catch (s) { throw i && (i.jserror = !0), s }
                    i && 4 == t.readyState && (i.cbTime = S() - o) } return a }) }
        Fn(t, e); try { G() ? Hn(t) : qn(t) } catch (n) {} if (!t[Bi]) { var r = L(function a() { var e = a;
                e._ && (e._ = 1), t[Bi] || 4 === t.readyState && Yn(t) }); try { G() ? $r(t, oa, r) : (t[Su] = r, t[Su][Bi] = !0) } catch (n) { return } }
        hs(function() { Fn(t, e) }) }

    function Yn(t) { var e = t[fa]; if (e && (e.end = S(), e.readyState = t.readyState, 4 == t.readyState)) { delete t[Bi], Bn(e), e.status = t.status, e.text = Gn(t), e.resSize = T(e.text); var n = Kn(e, t),
                r = ss.get("event");
    ...
    function Gn(t) { var e = ""; if ("" == t.responseType || "text" == t.responseType) e = t.responseText;
    ...
    function Kn(e, n) { if (e && !e.composed) { var r = e.status; if (jo.isGather) { var a = Wn(e.context);
            ...
            m(e.contextData, { end: e.end, du: r > 0 ? e.end - e.start : 0, cb: e.cbTime || 0, status: r, err: e.errorCode ? e.errorCode : 0, rec: e.resSize, send: e.reqSize }); var i = e.contextData,
                o = {};
            o[Sa] = e.reqHeaderParam || {}; var s = wt(e.url),
                u = s.bizIdParams,
                c = s.params,
                f = s.requestParams,
                l = s.optCustomParams,
            ...
            o[Ea] = It(er(e.requestData), Lo.optCustomParamRules[Ea], !0); var v = Qn(n, Lo.bizIdsRules),
                g = Qn(n, Lo.customParamsRules);
            o[Ta] = Qn(n, Lo.optCustomParamRules, Ta); var y = {},
                _ = {},
                x = Y(e.text);
            x && (y = Zn(x, Lo.bizIdsRules), _ = Zn(x, Lo.customParamsRules), o[Ca] = It(x, Lo.optCustomParamRules[Ca], !0)), i.bizId_param = m({}, u, d, v, y), i.opt_param = m({}, c, p, g, _), i.request_param = m({}, f, h), i.opt_custom_param = Nt(Vn(o, l)); var b = e.xTingyunSent ? Y(Xn(n, Na)) : null; if (b) { if (i.hasServerHeader = !0, i.s_id = b.id, i.s_tname = b.tname, i.s_tid = b.tid, i.s_rid = b.rid, i.s_duration = b.duration, "user" in b) { var S = b.user,
                        E = S; if (null != S && 0 === S.indexOf(Ia)) { var T = S.substring(Ia.length); try { E = Ts.decode(T) } catch (C) {} }
                    i.s_user = E, Tt(E) } "bid" in b && (i.s_bid = Pt(b.bid)), "ber" in b && (i.s_ber = b.ber), "isError" in ws && (i.s_isError = b.isError) } else i.hasServerHeader = !1;
            e.apms && (i.apms = e.apms), e.key && (i.__spe = 1); var A = {}; return Lo.collectAllParam[So] && s.operaAllParam && (A[So] = s.operaAllParam), Lo.collectAllParam[Eo] && e.headerRecord && (A[Eo] = e.headerRecord), Lo.collectAllParam[To] && e.requestData && (A[To] = e.requestData), Lo.collectAllParam[Co] && (A[Co] = n.getAllResponseHeaders()), Lo.collectAllParam[Ao] && e.text && (A[Ao] = e.text), At(A) || (i.opera_all_param = A), e.composed = !0, i } }
    ...
    function Qn(t, e, n) { var r = {}; return i(e[n || va], function(e) { var n = Xn(t, e);
            null != n && nt(r, e, n) }), r }

    function Zn(t, e, n) { var r = {}; return i(e[n || ga], function(e) { var n = Dt(Aa, e),
                a = n(t);
            null != a && nt(r, e, a) }), r }
    ...
    function rr() { var e = No && No.prototype;
    ...
    function vr(t, e, n) {
        function r() { if (a.end = S(), a.sameOrigin && this && this.contentDocument && this.contentWindow) { a.sameOrigin = !0, a.url = this.contentDocument.URL; var e = Ot(Da, Ra, this.contentWindow[Ra] || this.contentDocument.cookie || ""); if (e) { var n = jt(e);
                    kt(Da, "", -1e3, "/", this.contentDocument), a.serverData = qt(n) } var i = this.contentWindow[la],
                ...
                i && (a.pvid = i.pvid || ""); var u; try { u = gn(o, s) } catch (c) { u = {} }
                a.pfData = u, a.pfData.le && (a.end = o.navigationStart + a.pfData.le) } else a.sameOrigin = !1;
            hr(a), gr(a), t.removeEventListener("load", r) } if (t) { n || (n = t.src ? Ru : wu); var a = { id: Au++, src: e, loadType: n, start: S(), parentContext: Go.context };
    ...
    function Sr(t) { var e = Du++,
            n = t.url || "",
            r = S(),
            a = ne.createEvent(Go.context, "".concat(n, "-").concat(e), Fa, t.subType || Ei),
            i = { type: Fa, subType: a.subType, id: e, cid: a.id, url: n, start: r };
        a && a.setData(i); var o; return a.parent && (a.parent.type === La ? Kn(Go.globalAsyncStore, Go.globalAjaxContext) : a.parent.type === Ma && ar(Go.globalAsyncStore), o = a.collectCrossPageData(), Pu = o, t.delayStorage || br(o), a.clear(), a = null), { storageData: o, context: a } }

    function Er(t) { return function() { var e = arguments[0],
                n = Sr({ url: e, delayStorage: !0 }),
                r = n.storageData,
                a = n.context; try { var i = t.apply(this, arguments); if (i) { if (!r && a) { var o = Ce(a.data.start);
    ...
    function Cr() {
        ...
        i([Di, Pi], function(n) { Po.addEventListener(n, function(r) { if (r) { var a = n === Di ? t(r) : e(r); if (a.valid) { var i = r.timeStamp ? Ae(r) : Ce(Te(r));
                        i && (Go.context = i, Sr({ subType: a.subType, url: a.url }), Go.context = null) } } }, _defineProperty({}, Ri, !0)) }) }
    ...
    function Nr() { Nu.forEach(function(e) { M(t.history, e, function(n) { return function(r, a, i) { var o;
                    o = n.apply(this, arguments); try { Pr(t.location.href, e) } catch (s) {} return o } }) }), $r(t, po, function() { Pr(t.location.href, po) }) }

    function Ir() { $r(t, lo, function() { Pr(t.location.href, lo) }) }

    function Or() { var e = t.history;
        e ? Nr() : Ir() }

    function kr() { Mo.router_enable && Or() }

    function jr() { if (G()) try { $r(t, "message", Yt) } catch (e) {}
        if (Ye(ws), G() && Dr(), wn(), rr(), tn(), kr(), ws._end = S(), Me(function() { zs._end = ws._end }), rn(), G()) { var n = Y(rs(Si));
    ...
    var es;
    U.prototype = { createContext: function() { return Object.create ? Object.create(this.active) : B(this.active) }, get: function(t) { return this.active ? this.active[t] : void 0 }, set: function(t, e) { return this.active ? this.active[t] = e : void 0 }, enter: function(t) { if (!t) throw new Do("context required!");
            this._set.push(this.active), this.active = t }, exit: function(t) { if (!t) throw new Do("context required!"); if (t === this.active) return void(this.active = this._set.pop()); var e = this._set.lastIndexOf ? this._set.lastIndexOf(t) : y(this._set, t); if (0 > e) throw new Do("context not currently entered!");
    ...
    $.prototype.add = function(t) { this.queue.length >= this.size || (this.queue.push(t), this.running || (this.running = !0, this.run())) }, $.prototype.run = function() { var t = this,
        ...
        this.handler(this.queue.shift(), e) }, $.prototype.handler = function(t, e) { fs(t, E(function() { e() })) }, fs = t.XDomainRequest ? K : V, Oo.sendBeacon && (gs = !0);
    var ys = ds();
    ...
    var _s, xs = t.location.protocol,
        ...
        Ss = {},
        Es = t,
        Ts = function() { var t = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
    ...
    var Rs = [La, Ma, Ba];
    ne.prototype.end = function(t) { if (this.closed) return void(!this.cleared && Mo.debug_context_closed && console.warn("Current context is already closed")); if (t && (this.actionCount.ajax += t.actionCount.ajax, this.actionCount.iframe += t.actionCount.iframe, te(this.items, t), this.updateRemain(-1, t.type)), this.isNoRemain() || this.isTimeout)
    ...
    var Us = Ne.prototype;
    Us.end = Us.finish = Us.fail = null, Us.send = function(t) { this.sent = !0; var e = this.getEventData(t),
            n = this.timeout || Vi;
        (Mo.collect_hash_no_ajax || !(e.debugInfo && e.debugInfo.api === lo || e.type === Qi && e.key.indexOf("#") > -1) || 0 !== e.xhrs.length) && (e.duration >= n || De(e)) }, Us.getEventData = function(t) { var e = this,
            n = t.event && t.event.xhrs || [];
        i(n, function(t) { t.startSpeOffset = t.start - e.s }); var r = { key: e.key, start: e.s, duration: e.e - e.s, status: e.status, type: e.type, xhrs: n }; return this.debugInfo && (r.debugInfo = this.debugInfo), r }, Us.refreshEventAndStore = function(t) { this.finish(); var e = this.getEventData(t);
        as(Ji, Mr(e)) };
    var Fs = Lo.debuggable,
        zs = { start: e, e: {}, an: { count: 0 }, visible: [] };
    ! function() { if (Lo.debuggable) { var t, e, n = "visibilitychange";
    ...
    var Xs = new Ge(100),
        $s = {},
        Qs = {};
    Ke.prototype = { increase: function() { this.recordFileName(), this.count++ }, recordFileName: function() { var t = this.filename || "_";
            this.fep += Qs[t] ? 0 : 1, Qs[t] = !0 }, fix: function() { var t = this,
                e = t.stack; if (e && Br(e)) { e = e.split(/\n/); var n = [];
                i(e, function(t, e) {-1 == t.indexOf(ha) && n.push(t) }), t.stack = n.join("\n") } }, toObject: function() { var t = this,
                e = { o: t.time, e: t.msg, l: t.lineno, c: t.colno, r: t.filename, ec: t.count, s: t.stack, m: t.module, ep: t.ep, fep: t.fep, tr: t.trigger }; return t.metaData && (e.meta = t.metaData), e } };
...
window.TINGYUN && window.TINGYUN.init && window.TINGYUN.init(function(ty_rum) { ty_rum.server = { "dr_threshold": 600, "opt_custom_param_rule": [], "apm_headers": ["wjn_test", "ceshi2", "ceshi1"], "router_enable": true, "fp_threshold": 400, "token": "fed02fd6eed04e659c6a5d1cf18d8c53", "beacon": "wkbrst2.tingyun.com", "trace_threshold": 2000, "x_server_switch": true, "ignore_err": false, "id": "uazOcuIoeLI", "key": "L4pEq6b4ZL8", "fs_threshold": 800 } }); /*TY_AGENT_END*/