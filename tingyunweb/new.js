...
window.TINGYUN = function(t, e) {
    ...
    function $t(e) {
        ...
        ht(_s);
        var s = Lt(gs);
        ys.pageServerData = Ht(s), Gt(_s, ys), Z(_s.req_capacity)
    }
    ...
    function Ee(t, e) {
        if (t) {
            ...
            if (n) try {
                var r = n + oa(t),
                    a = [r];
                a.unshift(e.commonActionInfoMessage ? e.commonActionInfoMessage : be());
                var i = a.join("\n"),
                    o = { ps: e.crossPage || n === mi ? 1 : 0 };
                m(o, e.query || {}), cc.emit("send", "/action", o, i, function() { t.type === ci && (cc.xhrs = cc.errs = null, ye()), e.cb && e.cb() }, e.url)
            } catch (s) {}
        }
    }
    ...
    function Hn(t, e) {
        if (Ln()) {
            var n = { rm: {}, em: [], cpm: {} };
            e && (n.rm.res = e.res || []), t && (n.cpm = t, n.cpm.ul = fs.URL), nbsJsBridge.logJsResult(oa(n))
        }
    }
    ...
    var Ea = "error",
        ...
        ys = gs.appConf,
        _s = gs.server,
        xs = { pvid: ys.pvid, ref: fs.URL, referrer: fs.referrer, v: "3.2.2", av: "3.2.2" },
    ...
    var nu = { mainVersion: oo, version: "3.2.2", key: _s.key, pvid: ys.pvid, DIAGNOSE_HREF: Ia, diagnose: N, createEvent: ln, logFirstScreen: kn, addExcludedDomain: jn, globalStart: e, currentAgent: cc, mark: hn, wrapVueRouter: pn, endSession: gt, setUid: Tt, createAutoEvent: ln, endStoreEvent: fn, captureException: Nn, setDid: Ct, addHook: xn, addLifeCycleHook: bn, addActionHook: En, setContext: Ut, setExtraContext: Ft, stopLCPObserver: _e },
        ru = 0,
        au = "{0} not support",
        iu = 0,
...
// window.TINGYUN && window.TINGYUN.init && window.TINGYUN.init(function(ty_rum) { ty_rum.server = { "dr_threshold": 600, "opt_custom_param_rule": [], "apm_headers": ["wjn_test", "ceshi2", "ceshi1"], "router_enable": true, "fp_threshold": 400, "token": "fed02fd6eed04e659c6a5d1cf18d8c53", "beacon": "wkbrst2.tingyun.com", "trace_threshold": 2000, "x_server_switch": true, "cors_domains": ["192.168.5.114:8089"], "ignore_err": false, "id": "uazOcuIoeLI", "key": "L4pEq6b4ZL8", "fs_threshold": 800 } }); /*TY_AGENT_END*/
...
// window.TINGYUN && window.TINGYUN.init && window.TINGYUN.init(function(ty_rum) { ty_rum.server = { "beacon": "10.128.2.95:8588", "trace_threshold": 2022, "x_server_switch": true, "dr_threshold": 603, "opt_custom_param_rule": [], "ignore_err": false, "id": "QPo-y6LCVc8", "key": "86JzoBuZ7Dw", "router_enable": true, "fp_threshold": 403, "fs_threshold": 822, "token": "0e7c8515e7fc450f9010b2b69bfb9856" } }); /*TY_AGENT_END*/
// window.TINGYUN && window.TINGYUN.init && window.TINGYUN.init(function(ty_rum) { ty_rum.server = { "event_timeout": 60000, "dr_threshold": 600, "opt_custom_param_rule": [], "apm_headers": ["ceshi2", "ceshi1"], "cross_page_delay": 3000, "router_enable": true, "fp_threshold": 400, "token": "249b5fe444314d449eea296bc32b07c0", "beacon": "wkbrst1.tingyun.com", "trace_threshold": 2002, "x_server_switch": true, "cors_domains": ["192.168.5.114:8089"], "ignore_err": false, "id": "fui3qc_SnwM", "key": "rY3mSyYR9f8", "fs_threshold": 800 } }); /*TY_AGENT_END*/
// window.TINGYUN && window.TINGYUN.init && window.TINGYUN.init(function(ty_rum) { ty_rum.server = { "beacon": "10.128.2.95:8588", "trace_threshold": 2022, "x_server_switch": true, "dr_threshold": 603, "opt_custom_param_rule": [], "ignore_err": false, "cors_domains": ["192.168.5.114:8089"], apm_headers: ['ceshi2', 'ceshi1'], "id": "QPo-y6LCVc8", "key": "86JzoBuZ7Dw", "router_enable": true, "fp_threshold": 403, "fs_threshold": 822, "token": "0e7c8515e7fc450f9010b2b69bfb9856" } }); /*TY_AGENT_END*/

window.TINGYUN && window.TINGYUN.init && window.TINGYUN.init(function(ty_rum) { ty_rum.server = { "dr_threshold": 603, "opt_custom_param_rule": [], "apm_headers": ["ceshi2", "ceshi1"], "router_enable": true, "fp_threshold": 403, "token": "0e7c8515e7fc450f9010b2b69bfb9856", "beacon": "10.128.2.95:8588", "trace_threshold": 2022, "x_server_switch": true, "beacon_config": { "http": "http://10.128.111111", "https": "https://10.128.111111" }, "ignore_err": false, "id": "QPo-y6LCVc8", "key": "86JzoBuZ7Dw", "fs_threshold": 822 } }); /*TY_AGENT_END*/